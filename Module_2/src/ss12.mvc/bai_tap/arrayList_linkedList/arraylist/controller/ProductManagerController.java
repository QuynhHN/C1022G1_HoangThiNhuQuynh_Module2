package ss12.mvc.bai_tap.arrayList_linkedList.arraylist.controller;
...
public class ProductManagerController {
    public static final IProductService productManagerService = (IProductService) new ProductService();
